<template>
   ...
   >
      <g class="first-row">
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-10"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-11"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-12"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-13"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-14"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-15"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-16"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-17"
      ...
      <g class="second-row">
         <path
            fill="#41B883"
            class="svg-typewriter-letter-18"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-19"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-20"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-21"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-22"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-23"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-24"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-25"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-26"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-27"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-28"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-29"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-30"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-31"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-32"
         ...
         <path
            fill="#41B883"
            class="svg-typewriter-letter-33"
...
[class^="svg-typewriter-letter"] {
   visibility: hidden; // Initially hidden
   animation-fill-mode: forwards; // Persist final state of animation
}

@keyframes typewriter {
   from {
      width: 0;
      visibility: visible; // Show during the animation
   }
   to {
      width: 100%;
      visibility: visible; // Explicitly visible at the end
   }
}

@for $index from 1 through 33 {
   .svg-typewriter-letter-#{$index} {
      animation: typewriter 2.5s steps(33) (2.92s + (0.1s * $index)) forwards;
   }
}
